...
func (np *NodePlugin) ISCSiStageVolume(ctx context.Context, req *csi.NodeStageVolumeRequest) error {
	// Scan for targets
	l := jcom.LFC(ctx)

	l = l.WithFields(log.Fields{
		"func":    "ISCSiStageVolume",
		"section": "node",
	})
...
// StageVolume discovers iscsi target and attachs it
func (np *NodePlugin) ISCSiUnStageVolume(ctx context.Context, req *csi.NodeStageVolumeRequest) error {
	var msg string

	l := jcom.LFC(ctx)

	l = l.WithFields(log.Fields{
		"func":    "ISCSIUnStageVolume",
		"section": "node",
	})
