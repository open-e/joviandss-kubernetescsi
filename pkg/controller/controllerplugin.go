...
func GetControllerPlugin(cp *ControllerPlugin, cfg *ControllerCfg, l *logrus.Logger) (
	err error,
) {
	...
	for _, sConfig := range cfg.StorageEndpoints {
		...
		log := l.WithFields(logrus.Fields{
			"app": "JovianDSS-CSI-Controller-Plugin",
			"version": "1.0.0",
		})

		storage, err = rest.NewProvider(&sConfig, log)
		if err != nil {
