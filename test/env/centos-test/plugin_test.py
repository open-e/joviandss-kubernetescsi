...
def register_container_in_vm(root, version):
    ...
    cmd = "docker load < ./build/src/_output/joviandss-csi-c:" + version
...
def start_plugin(version):
    ...
    ctrl = "/src/deploy/joviandss/joviandss-csi-controller-c.yaml"

    node = "/src/deploy/joviandss/joviandss-csi-node-c.yaml"

    sc = "/home/vagrant/configs/joviandss-csi-sc.yaml"

    lctrl = "/home/vagrant/joviandss-csi-controller.yaml"
    lnode = "/home/vagrant/joviandss-csi-node.yaml"
    ...
    specify_plugin_version = [ "sed", "-i", "s/opene\/joviandss-csi-c:latest/opene\/joviandss-csi-c:"+  version + "/g"]
