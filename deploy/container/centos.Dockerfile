...
RUN yum -y install ca-certificates e2fsprogs util-linux iproute wget zip bzip2 socat e2fsprogs exfatprogs xfsprogs dosfstools cifs-utils gdisk rsync procps util-linux nvme-cli fuse3 nfs-utils
# btrfs-progs fatresize ntfs-3g nfs-common fdisk cloud-guest-utils
